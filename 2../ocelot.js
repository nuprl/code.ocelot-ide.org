...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__workerManager_js__ = __webpack_require__(3452);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__languageFeatures_js__ = __webpack_require__(3453);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__tokenization_js__ = __webpack_require__(3455);
/*---------------------------------------------------------------------------------------------
...
function setupMode(defaults) {
    ...
    disposables.push(monaco.languages.setTokensProvider(languageId, __WEBPACK_IMPORTED_MODULE_2__tokenization_js__["a" /* createTokenizationSupport */](true)));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__scanner_js__ = __webpack_require__(3322);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function format(documentText, range, options) {
    ...
    var scanner = __WEBPACK_IMPORTED_MODULE_0__scanner_js__["a" /* createScanner */](formatText, false);
    var hasError = false;
...
function visit(text, visitor, options) {
    var _scanner = __WEBPACK_IMPORTED_MODULE_0__scanner_js__["a" /* createScanner */](text, false);
...
function stripComments(text, replaceCh) {
    var _scanner = __WEBPACK_IMPORTED_MODULE_0__scanner_js__["a" /* createScanner */](text), parts = [], kind, offset = 0, pos;
    do {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__deps_vscode_languageserver_types_main_js__ = __webpack_require__(3454);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__deps_jsonc_parser_main_js__ = __webpack_require__(3456);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__impl_format_js__ = __webpack_require__(3358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__impl_edit_js__ = __webpack_require__(3457);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__impl_scanner_js__ = __webpack_require__(3322);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__impl_parser_js__ = __webpack_require__(3359);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__format_js__ = __webpack_require__(3358);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parser_js__ = __webpack_require__(3359);
/*---------------------------------------------------------------------------------------------
 *  Copyright (c) Microsoft Corporation. All rights reserved.
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
...
function setProperty(text, path, value, formattingOptions, getInsertionIndex) {
    var errors = [];
    var root = __WEBPACK_IMPORTED_MODULE_1__parser_js__["e" /* parseTree */](text, errors);
    var parent = void 0;
    var lastSegment = void 0;
    while (path.length > 0) {
        lastSegment = path.pop();
        parent = __WEBPACK_IMPORTED_MODULE_1__parser_js__["a" /* findNodeAtLocation */](root, path);
    ...
    if (!parent) {
        ...
        var existing = __WEBPACK_IMPORTED_MODULE_1__parser_js__["a" /* findNodeAtLocation */](parent, [lastSegment]);
        if (existing !== void 0) {
            if (value === void 0) {
                if (!existing.parent) {
...
function withFormatting(text, edit, formattingOptions) {
    ...
    if (edit.length === 0 || edit.content.length === 0) {
        while (begin > 0 && !__WEBPACK_IMPORTED_MODULE_0__format_js__["b" /* isEOL */](newText, begin - 1)) {
            begin--;
        }
        while (end < newText.length && !__WEBPACK_IMPORTED_MODULE_0__format_js__["b" /* isEOL */](newText, end)) {
            end++;
        }
    }
    var edits = __WEBPACK_IMPORTED_MODULE_0__format_js__["a" /* format */](newText, { offset: begin, length: end - begin }, formattingOptions);
